# Contributing to perufaunads004

This outlines how to propose a change to perufaunads004.
...
*   Fork the package and clone onto your computer. If you haven't done this before, we recommend using `usethis::create_from_github("PaulESantos/perufaunads004", fork = TRUE)`.
...
Please note that the perufaunads004 project is released with a
