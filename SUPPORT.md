...
Thanks for using perufaunads004! Before filing an issue, there are a few
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/PaulESantos/perufaunads004/issues/new).
...
requests](https://github.com/PaulESantos/perufaunads004/issues) to make
