...
This outlines how to propose a change to perufaunads004. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("PaulESantos/perufaunads004", fork = TRUE)`.
...
[Contributor Code of
Conduct](https://paulesantos.github.io/perufaunads004/CODE_OF_CONDUCT.md).
